...
public class SpellStoneSetup
{
    ...
    public SpellStoneSetup(Item item, int width, int height, bool isQuiver = false, bool isOreBag = false, bool replaceShader = true)
    {
        ...
        statusEffect.name = $"SE_SpellStone_{item.Prefab.name}";
